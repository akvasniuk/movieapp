...
import { parseJwt, handleLogError } from '../helpers/Helpers'
      ...
      return (
          <Grid textAlign='center'>
            <Grid.Column style={{ maxWidth: 450 }}>
              ...
              {isError && <Message negative>The username or password provided are incorrect
                or you don't verify your mail!</Message>}
            </Grid.Column>
          </Grid>
      )
    }
